...
BUSHFIRELIST_LATEST_LAYER=decouple.config("BUSHFIRELIST_LATEST_LAYER", default="dpaw:bushfirelist_latest_uat")
BUSHFIRE_LATEST_LAYER=decouple.config("BUSHFIRE_LATEST_LAYER", default="dpaw:bushfire_latest_uat")
BUSHFIRE_FINAL_FIREBOUNDARY_LATEST_LAYER=decouple.config("BUSHFIRE_FINAL_FIREBOUNDARY_LATEST_LAYER", default="dpaw:bushfire_final_fireboundary_latest_uat")
BUSHFIRE_FIREBOUNDARY_LATEST_LAYER=decouple.config("BUSHFIRE_FIREBOUNDARY_LATEST_LAYER", default="dpaw:bushfire_fireboundary_latest_uat")
